...
class FaceView: UIView {
    ...
    private struct Scaling {
        ...
        static let FaceRadiusToMouthOffsettRatio: CGFloat = 3
    }
    ...
    private func bezierPathForEye(whichEye: Eye) -> UIBezierPath {
        ...
        switch whichEye {
        case .Left: eyeCenter.x -= eyeHorizontalOffset / 2
        case .Right: eyeCenter.x += eyeHorizontalOffset / 2
        }
    ...
    private func bezierPathForSmile(fractionOfSmile: Double) -> UIBezierPath {
        ...
        let mouthVerticalOffset = faceRadius / Scaling.FaceRadiusToMouthOffsettRatio
    ...
    func setSmileValue(newValue: Double) {
        smiliness = newValue
    }
